...
(
    ...
    "authorId"    int(10) default '0',
    "type"        varchar(16)  default 'domain',
    "price"       int(10) default '0',
    "link"        varchar(200) default NULL,
    "visitCount"  int(10) default '0',
    "status"      varchar(16)  default 'sale'
);

CREATE UNIQUE INDEX typecho_contents_title ON typecho_contents ("title");
...
CREATE UNIQUE INDEX typecho_metas_name ON typecho_metas ("name");
