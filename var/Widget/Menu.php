...
use Widget\Metas\Status\Admin as StatusAdmin;
use Widget\Metas\Status\Edit as StatusEdit;
use Widget\Metas\Tag\Admin as TagAdmin;
use Widget\Contents\Domain\Edit as DomainEdit;
use Widget\Contents\Domain\Admin as DomainAdmin;
use Widget\Metas\Platform\Admin as PlatformAdmin;
...
class Menu extends Base
{
    ...
    {
        $parentNodes = [null, _t('控制台'), _t('新增'), _t('管理'), _t('设置')];
        ...
        $childNodes = [
            ...
            [
                [_t('新增域名'), _t('添加新域名'), 'write-domain.php', 'contributor'],
                [[DomainEdit::class, 'getMenuTitle'], [DomainEdit::class, 'getMenuTitle'], 'write-domain.php?cid=', 'contributor', true],
            ],
            [
                [_t('域名'), _t('管理域名'), 'manage-domains.php', 'contributor', false, 'write-domain.php'],
                [[DomainAdmin::class, 'getMenuTitle'], [DomainAdmin::class, 'getMenuTitle'], 'manage-domains.php?uid=', 'contributor', true],
                [_t('平台'), _t('管理平台'), 'manage-platforms.php', 'editor'],
                [[PlatformAdmin::class, 'getMenuTitle'], [PlatformAdmin::class, 'getMenuTitle'], 'manage-platforms.php?mid=', 'editor', true],
            ...
            [
                ...
                [_t('增强'), _t('增强设置'), 'options-extend.php', 'administrator'],
            ]
        ];
